...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Dao
{
    class SearchJigRepairInformationDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append(@"SELECT a.jig_repair_id, a.jig_repair_cd, c.model_name, c.model_cd, b.line_name, d.process_work_name, g.process_name, e.jig_cause_name, f.jig_response_name,
...
left join m_process_work d on d.process_work_id =a.process_work_id
left join m_process g on g.process_id =d.process_id
left join m_ncvp_jig_cause e on e.jig_cause_id =a.jig_cause_id
left join m_ncvp_jig_response f on f.jig_response_id = a.jig_response_id
 WHERE  ");
