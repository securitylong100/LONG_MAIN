...
namespace Com.Nidec.Mes.Common.Basic.MachineMaintenance.Dao
{
    class SearchReportDownTimeDao : AbstractDataAccessObject
    {
        public override ValueObject Execute(TransactionContext trxContext, ValueObject vo)
        {
            ...
            sql.Append(@"SELECT a.downtime_report_id, d.model_cd, f.process_name, e.process_work_name, h.line_cd, i.machine_name, k.defective_reason_name, o.prodution_work_content_name, a.time_to, a.time_from , a.registration_user_cd,a.remarks
from t_downtime_report a 
left join m_ncvp_model d on a.model_id = d.model_id
left join m_process_work e on a.process_work_id=e.process_work_id
inner join m_process f on f.process_id=e.process_id
